...
export function initWithdraw() {
  ...
  onAuthStateChanged(auth, async (user)=>{
    ...
    // 1) subscribe saldo user
    // (pakai getDoc sekali + listener withdrawals; saldo user jarang berubah dari sini)
...
function renderBalance(){
  // di dashboard/withdraw ada kelas ini
...
function calcAvailable(){
  ...
  // bisa ditampilkan kalau mau: hint saldo tersedia
  // console.debug('[WD] balance=', CURRENT_BALANCE, 'pending=', PENDING_TOTAL, 'available=', AVAILABLE);
}
